...
const FIXED_SOLEMNITIES = [
  ...
  { month: 6, day: 11, theme: "MARTYRDOM" },    // St. Benedict (July 11)
  { month: 6, day: 16, theme: "MARTYRDOM" },    // Our Lady of Mount Carmel (July 16)
  { month: 6, day: 20, theme: "MARTYRDOM" },    // St. Apollinaris (July 20)
  { month: 6, day: 22, theme: "SOLEMNITIES" },  // St. Mary Magdalene (July 22)
  { month: 6, day: 25, theme: "MARTYRDOM" },    // St. James, Apostle (July 25)
  { month: 6, day: 31, theme: "MARTYRDOM" },    // St. Ignatius of Loyola (July 31)
  { month: 7, day: 1, theme: "MARTYRDOM" },     // St. Alphonsus Liguori (Aug 1)
  { month: 7, day: 2, theme: "MARTYRDOM" },     // St. Peter Chrysologus (Aug 2)
